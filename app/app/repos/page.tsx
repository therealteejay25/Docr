        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-white/60">
              {repos.length} repository{repos.length !== 1 ? "ies" : ""}{" "}
              connected
            </p>
          </div>
          <motion.button
            ...
            className="flex items-center gap-2 px-6 py-3 bg-white text-black font-semibold rounded-lg hover:bg-white/90 transition-colors cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredRepos.map((repo, index) => (
            <motion.div
              ...
              className="group relative bg-base border border-white/10 hover:border-white/20 rounded-2xl p-6 overflow-hidden transition-all hover:shadow-xl hover:shadow-white/5"
            >
                ...
                <div className="flex gap-3 pt-4 border-t border-white/10">
                  <Link href={`/app/repos/${repo._id}`} className="flex-1">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-white text-black font-medium rounded-lg hover:bg-white/90 transition-colors cursor-pointer"
                    >
                      <span>View</span>
                      <CaretRight size={16} />
                    </motion.button>
                  ...
                  <motion.button
                    ...
                    className="px-4 py-2 bg-red-500/10 text-red-400 hover:bg-red-500/20 border border-red-500/30 font-medium rounded-lg transition-colors cursor-pointer disabled:opacity-50 text-sm"
                  >
