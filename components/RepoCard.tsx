...
import { ClockCounterClockwiseIcon, CoinsIcon, GitCommitIcon } from '@phosphor-icons/react'
...
const RepoCard = () => {
  return (
    <div className='h-72 w-80 flex flex-col justify-between rounded-3xl bg-base p-6'>
        ...
        <motion.button whileHover={{ scale: 1.05, y: -1 }} className="bg-white cursor-pointer text-base rounded-full w-full p-3 font-semibold">
        View Project
        </motion.button>
    </div>
  )
